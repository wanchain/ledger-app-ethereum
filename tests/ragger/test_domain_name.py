...
def test_send_fund_very_long_domain_name(app_client: EthereumClient):
    challenge = common(app_client)

    app_client.provide_domain_name(challenge, LONG_NAME, ADDR)
