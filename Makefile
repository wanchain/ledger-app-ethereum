...
APP_LOAD_FLAGS= --appFlags 0x240 --dep Ethereum

# Version of the Ethereum library API for inter-app calls
LIB_INTERFACE_VERSION=1
...
DEFINES   += LIB_INTERFACE_VERSION=$(LIB_INTERFACE_VERSION)
